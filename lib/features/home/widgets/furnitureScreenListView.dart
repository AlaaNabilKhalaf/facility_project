                ...
                return  GestureDetector(
                  onTap: (){
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context)=> LaZBoyScreen(index: index, heartColor: false)));
                  },
                  child: Padding(
                        ...
                        Row(
                          children: [
                           ...
                           crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                SizedBox(height: 5.h,),
                              Text(textOne[index],style: const TextStyle(fontSize: 15),),
                                const Text('Furniture and interior Design',
                                         maxLines: 2,
                                         style: TextStyle(
                                             fontSize: 12,
                                             color: Colors.grey

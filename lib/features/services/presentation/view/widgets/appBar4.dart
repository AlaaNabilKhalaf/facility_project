...
class AppBarButtom4 extends StatefulWidget  implements PreferredSizeWidget {

  final String text;
  Widget? columnText;
  AppBarButtom4({super.key, required this.text,this.columnText});

  @override
  State<AppBarButtom4> createState() => _AppBarButtom2State();
...
class _AppBarButtom2State extends State<AppBarButtom4> {
  @override
